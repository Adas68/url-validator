...
class TestBlacklist(unittest.TestCase):
    ...
    def test_blacklisted_url(self):
        ...
        self.assertTrue(check_blacklist("https://scam-site.org/login "))
        self.assertTrue(check_blacklist("http://malicious.site/redirect"))
    ...
    def test_partial_match_does_not_trigger_false_positive(self):
        # Make sure subdomains or similar names don't match unless they fully contain a blacklisted domain
